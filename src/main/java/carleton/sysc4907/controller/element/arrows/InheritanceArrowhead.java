...
public class InheritanceArrowhead extends AbstractArrowhead {
    ...
    private static final double ARROW_LENGTH_MULTIPLIER = 1.2;
    ...
    protected void drawArrowhead(
        ...
        var pointX = endX - ARROW_LENGTH_MULTIPLIER*size*mainDirectionX + ARROW_SIDE_WIDTH_MULTIPLIER*size*orthogonalDirectionX;
        var pointY = endY - ARROW_LENGTH_MULTIPLIER*size*mainDirectionY + ARROW_SIDE_WIDTH_MULTIPLIER*size*orthogonalDirectionY;
        path.getElements().add(new LineTo(pointX, pointY));
        pointX = endX - ARROW_LENGTH_MULTIPLIER*size*mainDirectionX - ARROW_SIDE_WIDTH_MULTIPLIER*size*orthogonalDirectionX;
        pointY = endY - ARROW_LENGTH_MULTIPLIER*size*mainDirectionY - ARROW_SIDE_WIDTH_MULTIPLIER*size*orthogonalDirectionY;
        path.getElements().add(new LineTo(pointX, pointY));
