...
public class CompositionArrowheadTest extends AbstractArrowheadTest {
    ...
    public void testMakeArrowheadPathDirect() {
        ...
        assertTrue(almostEqual(86, line.getX()));

        line = (LineTo) elements.get(2);
        assertTrue(almostEqual(50, line.getY()));
        assertTrue(almostEqual(72, line.getX()));

        line = (LineTo) elements.get(3);
        assertTrue(almostEqual(40, line.getY()));
        assertTrue(almostEqual(86, line.getX()));

        assertTrue(elements.get(4) instanceof ClosePath);
        assertSame(path.getFill(), Color.BLACK);
    }
    ...
    public void testMakeArrowheadPathEndHorizontal() {
        ...
        assertTrue(almostEqual(93, line.getX()));

        line = (LineTo) elements.get(2);
        assertTrue(almostEqual(100, line.getY()));
        assertTrue(almostEqual(86, line.getX()));
    ...
    public void testMakeArrowheadPathEndVertical() {
        ...
        assertTrue(almostEqual(193, line.getY()));

        line = (LineTo) elements.get(2);
        assertTrue(almostEqual(100, line.getX()));
        assertTrue(almostEqual(186, line.getY()));
