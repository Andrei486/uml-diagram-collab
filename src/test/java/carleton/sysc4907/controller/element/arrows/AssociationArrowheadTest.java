...
public class AssociationArrowheadTest extends AbstractArrowheadTest {
    ...
    public void testMakeArrowheadPathDirect() {
        ...
        assertTrue(almostEqual(84, line.getX()));
    ...
    public void testMakeArrowheadPathEndHorizontal() {
        ...
        assertTrue(almostEqual(92, line.getX()));
    ...
    public void testMakeArrowheadPathEndVertical() {
        ...
        assertTrue(almostEqual(192, line.getY()));
